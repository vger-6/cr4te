...
PROJECT_FACETS: tuple[FacetSpec, ...] = (
    ...
    FacetSpec(ProjectField.POSES, FacetLabels("Pose", "Poses"), frozenset({Domain.MODEL}), _FILTERABLE),
    ...
    FacetSpec(ProjectField.EDITORS, FacetLabels("Editor", "Editors"), frozenset({Domain.BOOK, Domain.FILM}), _FILTERABLE_LINES),
    ...
    FacetSpec(ProjectField.PRODUCERS, FacetLabels("Producer", "Producers"), frozenset({Domain.FILM, Domain.MUSIC}), _FILTERABLE_LINES),
