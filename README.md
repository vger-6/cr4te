...
A static site generator for organizing and showcasing creative media projects. You already have a large media collection (images, videos, audio files, documents) cr4te scans your existing folder structure, extracts metadata and media, and builds clean, searchable HTML galleries.
...
```bash
python cr4te.py build-html -i <input_folder> -o <output_folder> --label-preset film
```
