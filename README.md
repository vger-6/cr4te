...
See the [`cr4te.json`](https://github.com/vger-6/cr4te/example_data/Artists/Noomi/_cr4te.json) file from the example data.
...
```json
{
  ...
  "born_or_founded": "1974-10-23",
  "nationality": "American",
  "aliases": [],
  "portrait": "Alice/portrait.jpg",
  "featured_portrait": null,
