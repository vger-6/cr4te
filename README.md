...
MyArtists/
├── Alice/
│   ├── cr4te.json           # Auto generated json file with optional meta data override
...
|   ├── portrait.jpg         # Detectable portrait
│   └── Project1/            # Media folder
│       ├── cover.jpg        # Detectable project cover
│       ├── Landscape1.jpg
│       ├── clip.mp4
│       ├── document.pdf
│       ├── README.md        # Optional project description
│       └── SubGroup/        # Media folder
│           └── *.jpg
│           └── *.m4a
└── Bob & Charlie/           # Collaboration folder
    └── ProjectZ/            # Media folder
...
See also the [Quick-Start](https://github.com/vger-6/cr4te/blob/main/data/example_data#quick-start) which includes a step-by-step guide using example data.
