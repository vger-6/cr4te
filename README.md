...
<img src="data/example_data/project_page.png" alt="Screenshot Project Page" width="100%"/>
...
Artists/
├── Alice/
|   ├── meta                 # Optional meta data folder 
│   ├── cr4te.json           # Generated json file with optional meta data override
│   ├── README.md            # Optional description
|   ├── portrait.jpg         # Detected portrait
│   └── Project1/
│       ├── cover.jpg        # Detected poster
│       ├── Landscape1.jpg
│       ├── clip.mp4
│       ├── document.pdf
...
See also the [Step-by-Step Guide](https://github.com/vger-6/cr4te/blob/main/data/example_data#quick-start)
...
> **⚠️ Note**
> cr4te.json files are automatically generated by the build-json command and saved directly into each creator’s original folder (e.g., <input_folder>\*/cr4te.json). These files can be manually edited to override or extend metadata such as birth dates, aliases, tags, or project descriptions.
...
```bash
python cr4te.py build-html -i /<input_folder> -o <output_folder> --html-preset movies
```
...
Your configuration file should be in JSON format and can override labels and media matching rules. See this [config file](https://github.com/vger-6/cr4te/blob/main/data/cr4te_config.json) as an example.
...
See this [`cr4te.json`](https://github.com/vger-6/cr4te/blob/main/data/example_data/Artists/Noomi/_cr4te.json) file as an example.
