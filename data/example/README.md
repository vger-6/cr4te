...
> **⚠️ Note**
> `cr4te.json` files are automatically generated by the `build` command and saved directly into the original folders (e.g., `/path/to/cr4te/example/data/Artists/Noomi/cr4te.json`).
