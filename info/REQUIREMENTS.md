...
- **SITE-025:** Every generated page must expose its title as a full-width level-one heading with theme-defined presentation. Overview search controls must use body typography and remain visually aligned with the title while retaining usable single-line input behavior. Every theme must provide coherent contrast for both elements.
